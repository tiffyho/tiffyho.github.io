...
function unhideLightbox1() {
	...
	let lightbox1 = document.getElementById("doggo1");
	unhideLightbox(lightbox1);
}
...
function unhideLightbox2() {
	let lightbox2 = document.getElementById("doggo2");
	unhideLightbox(lightbox2);
...
function unhideLightbox3() {
	let lightbox3 = document.getElementById("doggo3");
	unhideLightbox(lightbox3);
